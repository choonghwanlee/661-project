...
def fine_tune(images, pred_masks, model_save_ckpt, model_load_ckpt=None, mode='iris', num_epochs=4, batch_size=2):
...
def generate_eval(images, modelCheckpointFilePath, model=None):
